...
!function (t, e) {
    ...
    var o, s, a, l = "transitionend", c = window.jQuery, u = function (t) {
            do {
                t += ~~(1e6 * Math.random())
            ...
            if (!t) return 0;
            var e = window.getComputedStyle(t), n = e.transitionDuration, i = e.transitionDelay, r = parseFloat(n),
                o = parseFloat(i);
            ...
            set: function (t, e, n) {
                "undefined" == typeof t.key && (t.key = {key: e, id: s}, s++), o[t.key.id] = n
            }, get: function (t, e) {
        ...
        }, w = Element.prototype, T = w.matches, D = w.closest, I = Element.prototype.querySelectorAll,
        S = Element.prototype.querySelector, O = function (t, e) {
    ...
    var C = function () {
        var t = O("Bootstrap", {cancelable: !0}), e = document.createElement("div");
    ...
    function X(t, e, n) {
        var i = "string" == typeof e, r = i ? n : e, o = t.replace(R, ""), s = M[o];
    ...
    function G(t, e, n, i, r) {
        if ("string" == typeof e && t) {
            n || (n = i, i = null);
            var o = X(e, n, i), s = o[0], a = o[1], l = o[2], c = Y(t), u = c[l] || (c[l] = {}),
                f = B(u, a, s ? n : null);
            if (f) f.oneOff = f.oneOff && r; else {
                var h = V(a, e.replace(P, "")), d = s ? function (t, e, n) {
                    return function i(r) {
                        for (var o = t.querySelectorAll(e), s = r.target; s && s !== this; s = s.parentNode) for (var a = o.length; a--;) if (o[a] === s) return j(r, s), i.oneOff && K.off(t, r.type, n), n.apply(s, [r]);
                        return null
                    }
                }(t, n, i) : function (t, e) {
                    return function n(i) {
    ...
    var K = {
            on: function (t, e, n, i) {
                ...
                if ("string" == typeof e && t) {
                    var r = X(e, n, i), o = r[0], s = r[1], a = r[2], l = a !== e, c = Y(t), u = "." === e.charAt(0);
                ...
                var i, r = e.replace(R, ""), o = e !== r, s = U.indexOf(r) > -1, a = !0, l = !0, u = !1, f = null;
        ...
        }, Q = "asyncLoad", q = window.CoreUIDefaults && window.CoreUIDefaults.prefix ? window.CoreUIDefaults.prefix : "c-",
        z = {
            ACTIVE: q + "active",
            NAV_DROPDOWN_TOGGLE: q + "sidebar-nav-dropdown-toggle",
            SHOW: q + "show",
            VIEW_SCRIPT: "view-script"
        }, Z = {CLICK_DATA_API: "click.coreui.asyncLoad.data-api", XHR_STATUS: "xhr"}, $ = {
            NAV_DROPDOWN: "." + q + "sidebar-nav-dropdown",
            NAV_LINK: "." + q + "xhr-link, ." + q + "sidebar-nav-link",
            NAV_ITEM: "." + q + "sidebar-nav-item",
            VIEW_SCRIPT: ".view-script"
        }, J = {defaultPage: "main.html", errorPage: "404.html", subpagesDirectory: "views/"}, tt = function () {
            function t(t, e) {
            ...
            return n._getConfig = function (t) {
                ...
                var e = this, n = this._element, i = this._config, r = new XMLHttpRequest;
                r.open("GET", i.subpagesDirectory + t);
                var o = new CustomEvent(Z.XHR_STATUS, {detail: {url: t, status: r.status}});
                n.dispatchEvent(o), r.onload = function (s) {
                    if (200 === r.status) {
                        o = new CustomEvent(Z.XHR_STATUS, {detail: {url: t, status: r.status}}), n.dispatchEvent(o);
    ...
    var nt = {
        ...
        }, it = "coreui.alert", rt = "." + it,
        ot = window.CoreUIDefaults && window.CoreUIDefaults.bsPrefix ? window.CoreUIDefaults.bsPrefix : "",
        st = {DISMISS: '[data-dismiss="' + ot + 'alert"]'},
        at = {CLOSE: "close" + rt, CLOSED: "closed" + rt, CLICK_DATA_API: "click" + rt + ".data-api"},
        lt = {ALERT: ot + "alert", FADE: ot + "fade", SHOW: ot + "show"}, ct = function () {
            function t(t) {
    ...
    var ft = "coreui.button", ht = "." + ft,
        ...
        pt = {ACTIVE: dt + "active", BUTTON: dt + "btn", FOCUS: "focus"}, gt = {
            ...
            return n.toggle = function () {
                var t = !0, e = !0, n = nt.closest(this._element, gt.DATA_TOGGLE);
                if (n) {
                    var i = nt.findOne(gt.INPUT, this._element);
                    if (i) {
                        if ("radio" === i.type) if (i.checked && this._element.classList.contains(pt.ACTIVE)) t = !1; else {
    ...
    var yt = {
        ...
        }, At = "carousel", wt = "coreui.carousel", Tt = "." + wt,
        Dt = window.CoreUIDefaults && window.CoreUIDefaults.bsPrefix ? window.CoreUIDefaults.bsPrefix : "",
        It = {interval: 5e3, keyboard: !0, slide: !1, pause: "hover", wrap: !0, touch: !0}, St = {
            ...
            wrap: "boolean",
            touch: "boolean"
        }, Ot = "next", Lt = "prev", Ct = "left", Nt = "right", Pt = {
            SLIDE: "slide" + Tt,
            SLID: "slid" + Tt,
            KEYDOWN: "keydown" + Tt,
        ...
        }, Wt = {TOUCH: "touch", PEN: "pen"}, kt = function () {
            function t(t, e) {
            ...
            return n.next = function () {
                ...
                if (!(t > this._items.length - 1 || t < 0)) if (this._isSliding) K.one(this._element, Pt.SLID, (function () {
                    return e.to(t)
                })); else {
                ...
                var n = t === Ot, i = t === Lt, r = this._getItemIndex(e), o = this._items.length - 1;
                if ((i && 0 === r || n && r === o) && !this._config.wrap) return e;
                var s = (r + (t === Lt ? -1 : 1)) % this._items.length;
                return -1 === s ? this._items[this._items.length - 1] : this._items[s]
            }, n._triggerSlideEvent = function (t, e) {
                var n = this._getItemIndex(t), i = this._getItemIndex(nt.findOne(Ht.ACTIVE_ITEM, this._element));
                return K.trigger(this._element, Pt.SLIDE, {relatedTarget: t, direction: e, from: i, to: n})
                ...
                var n, i, r, o = this, s = nt.findOne(Ht.ACTIVE_ITEM, this._element), a = this._getItemIndex(s),
                    c = e || s && this._getItemByDirection(t, s), u = this._getItemIndex(c), f = Boolean(this._interval);
                if (t === Ot ? (n = Rt.LEFT, i = Rt.NEXT, r = Ct) : (n = Rt.RIGHT, i = Rt.PREV, r = Nt), c && c.classList.contains(Rt.ACTIVE)) this._isSliding = !1; else if (!this._triggerSlideEvent(c, r).defaultPrevented && s && c) {
                    if (this._isSliding = !0, f && this.pause(), this._setActiveIndicatorElement(c), this._element.classList.contains(Rt.SLIDE)) {
                        ...
                        K.one(s, l, (function () {
                            c.classList.remove(n), c.classList.remove(i), c.classList.add(Rt.ACTIVE), s.classList.remove(Rt.ACTIVE), s.classList.remove(i), s.classList.remove(n), o._isSliding = !1, setTimeout((function () {
                                K.trigger(o._element, Pt.SLID, {relatedTarget: c, direction: r, from: a, to: u})
                            }), 0)
                        })), g(s, p)
                ...
                var i = A.getData(e, wt), o = r({}, It, {}, yt.getDataAttributes(e));
    ...
    var Mt = "class-toggler",
        ...
        Vt = "-sm,-md,-lg,-xl", Yt = "-show", jt = !1, Bt = "body", Xt = {CLASS_TOGGLER: Ut + "class-toggler"},
        Gt = {CLASS_TOGGLE: "classtoggle", CLICK_DATA_API: "click.coreui.class-toggler.data-api"},
        Ft = {CLASS_TOGGLER: "." + Ut + "class-toggler"}, Kt = function () {
            function t(t) {
                this._element = t
            }
            ...
            return n.toggle = function () {
                ...
                this._getElementDataAttributes(this._element).forEach((function (e) {
                    ...
                    n = "_parent" === i || "parent" === i ? t._element.parentNode : document.querySelector(i), r.forEach((function (e) {
                        var r = e.className, o = e.responsive, s = e.postfix,
                        ...
                        if (o) {
                            ...
                            if (c.forEach((function (t) {
                                ...
                                var e = new CustomEvent(Gt.CLASS_TOGGLE, {detail: {target: i, className: t}});
                                n.dispatchEvent(e)
                            })); else {
                                n.classList.add(r);
                                var f = new CustomEvent(Gt.CLASS_TOGGLE, {detail: {target: i, className: r}});
                                n.dispatchEvent(f)
                            }
                        } else {
                            n.classList.toggle(r);
                            var h = new CustomEvent(Gt.CLASS_TOGGLE, {detail: {target: i, className: r}});
                            n.dispatchEvent(h)
                        }
                    }))
                }))
                ...
                var e = this, n = t.dataset, i = "undefined" == typeof n.target ? Bt : this._getDataAttributes(n, "target"),
                    ...
                    a = "undefined" == typeof n.postfix ? Yt : this._getDataAttributes(n, "postfix"), l = [],
                    c = function (t, e) {
    ...
    var qt = "collapse", zt = "coreui.collapse", Zt = "." + zt,
        $t = window.CoreUIDefaults && window.CoreUIDefaults.bsPrefix ? window.CoreUIDefaults.bsPrefix : "",
        Jt = {toggle: !0, parent: ""}, te = {toggle: "boolean", parent: "(string|element)"}, ee = {
            SHOW: "show" + Zt,
            SHOWN: "shown" + Zt,
            HIDE: "hide" + Zt,
            HIDDEN: "hidden" + Zt,
            CLICK_DATA_API: "click" + Zt + ".data-api"
        }, ne = {SHOW: $t + "show", COLLAPSE: $t + "collapse", COLLAPSING: $t + "collapsing", COLLAPSED: $t + "collapsed"},
        ie = "width", re = "height",
        oe = {ACTIVES: "." + $t + "show, ." + $t + "collapsing", DATA_TOGGLE: '[data-toggle="' + $t + 'collapse"]'},
        se = function () {
            function t(t, e) {
                ...
                for (var n = _(nt.find(oe.DATA_TOGGLE)), i = 0, r = n.length; i < r; i++) {
                    var o = n[i], s = f(o), a = _(nt.find(s)).filter((function (e) {
                        return e === t
                    }));
            ...
            return n.toggle = function () {
                ...
                if (!this._isTransitioning && !this._element.classList.contains(ne.SHOW)) {
                    ...
                    if (!K.trigger(this._element, ee.SHOW).defaultPrevented) {
                        ...
                        var a = "scroll" + (s[0].toUpperCase() + s.slice(1)), c = h(this._element);
                ...
                if (!this._isTransitioning && this._element.classList.contains(ne.SHOW) && !K.trigger(this._element, ee.HIDE).defaultPrevented) {
                    ...
                    if (n > 0) for (var i = 0; i < n; i++) {
                        var r = this._triggerArray[i], o = f(r);
                ...
                var e = this, n = this._config.parent;
    ...
    if (K.on(document, ee.CLICK_DATA_API, oe.DATA_TOGGLE, (function (t) {
        ...
        var e = yt.getDataAttributes(this), n = f(this);
    ...
    var le = "undefined" != typeof window && "undefined" != typeof document && "undefined" != typeof navigator,
        ce = function () {
            for (var t = ["Edge", "Trident", "Firefox"], e = 0; e < t.length; e += 1) if (le && navigator.userAgent.indexOf(t[e]) >= 0) return 1;
            return 0
        }();
    ...
    function pe(t) {
        ...
        var e = he(t), n = e.overflow, i = e.overflowX, r = e.overflowY;
    ...
    function De(t) {
        var e = t.body, n = t.documentElement, i = ve(10) && getComputedStyle(n);
        return {height: Te("Height", e, n, i), width: Te("Width", e, n, i)}
    }
    ...
    function Ce(t) {
        return Le({}, t, {right: t.left + t.width, bottom: t.top + t.height})
    }
    ...
    function Ne(t) {
        ...
        try {
            if (ve(10)) {
                ...
                var n = Ae(t, "top"), i = Ae(t, "left");
                e.top += n, e.left += i, e.bottom += n, e.right += i
            } else e = t.getBoundingClientRect()
        } catch (t) {
        }
        var r = {left: e.left, top: e.top, width: e.right - e.left, height: e.bottom - e.top},
            o = "HTML" === t.nodeName ? De(t.ownerDocument) : {}, s = o.width || t.clientWidth || r.width,
            a = o.height || t.clientHeight || r.height, l = t.offsetWidth - s, c = t.offsetHeight - a;
        if (l || c) {
            var u = he(t);
    ...
    function Pe(t, e) {
        var n = arguments.length > 2 && void 0 !== arguments[2] && arguments[2], i = ve(10), r = "HTML" === e.nodeName,
            o = Ne(t), s = Ne(e), a = pe(t), l = he(e), c = parseFloat(l.borderTopWidth, 10),
        ...
        return (i && !n ? e.contains(a) : e === a && "BODY" !== a.nodeName) && (f = function (t, e) {
            var n = arguments.length > 2 && void 0 !== arguments[2] && arguments[2], i = Ae(e, "top"),
                r = Ae(e, "left"), o = n ? -1 : 1;
    ...
    function He(t, e, n, i) {
        ...
        if ("viewport" === i) o = function (t) {
            var e = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
                n = t.ownerDocument.documentElement, i = Pe(t, n), r = Math.max(n.clientWidth, window.innerWidth || 0),
                o = Math.max(n.clientHeight, window.innerHeight || 0), s = e ? 0 : Ae(n), a = e ? 0 : Ae(n, "left");
            ...
            if ("HTML" !== a.nodeName || function t(e) {
                ...
                var c = De(t.ownerDocument), u = c.height, f = c.width;
    ...
    function We(t, e, n, i, r) {
        ...
        var s = He(n, i, o, r), a = {
            ...
            return Le({key: t}, a[t], {area: (e = a[t], e.width * e.height)});
            var e
        })).sort((function (t, e) {
    ...
    function Ue(t, e, n) {
        n = n.split("-")[0];
        var i = xe(t), r = {width: i.width, height: i.height}, o = -1 !== ["right", "left"].indexOf(n),
    ...
    function Ke(t, e, n, i) {
        n.updateBound = i, Fe(t).addEventListener("resize", n.updateBound, {passive: !0});
        var r = pe(t);
        return function t(e, n, i, r) {
            var o = "BODY" === e.nodeName, s = o ? e.ownerDocument.defaultView : e;
            s.addEventListener(n, i, {passive: !0}), o || t(pe(s.parentNode), n, i, r), r.push(s)
    ...
    function Ze(t, e) {
        Object.keys(e).forEach((function (n) {
            var i = "";
            -1 !== ["width", "height", "top", "right", "bottom", "left"].indexOf(n) && ze(e[n]) && (i = "px"), t.style[n] = e[n] + i
        }))
    }
    ...
    function nn(t) {
        var e = arguments.length > 1 && void 0 !== arguments[1] && arguments[1], n = en.indexOf(t),
            i = en.slice(n + 1).concat(en.slice(0, n));
        return e ? i.reverse() : i
    }

    var rn = {FLIP: "flip", CLOCKWISE: "clockwise", COUNTERCLOCKWISE: "counterclockwise"};
    ...
    var sn = {
        placement: "bottom", positionFixed: !1, eventsEnabled: !0, removeOnDestroy: !1, onCreate: function () {
            ...
            shift: {
                order: 100, enabled: !0, fn: function (t) {
                    ...
                    if (i) {
                        var r = t.offsets, o = r.reference, s = r.popper, a = -1 !== ["bottom", "top"].indexOf(n),
                            ...
                            u = {start: Oe({}, l, o[l]), end: Oe({}, l, o[l] + o[c] - s[c])};
                ...
                order: 300, enabled: !0, fn: function (t, e) {
                    ...
                    var i = Xe("transform"), r = t.instance.popper.style, o = r.top, s = r.left, a = r[i];
                    r.top = "", r.left = "", r[i] = "";
                ...
                order: 500, enabled: !0, fn: function (t, e) {
                    ...
                    var r = t.placement.split("-")[0], o = t.offsets, s = o.popper, a = o.reference,
                        ...
                        f = u.toLowerCase(), h = l ? "left" : "top", d = l ? "bottom" : "right", p = xe(i)[c];
                    a[d] - p < s[f] && (t.offsets.popper[f] -= s[f] - (a[d] - p)), a[f] + p > s[d] && (t.offsets.popper[f] += a[f] + p - s[d]), t.offsets.popper = Ce(t.offsets.popper);
                    var g = a[f] + a[c] / 2 - p / 2, m = he(t.instance.popper), _ = parseFloat(m["margin" + u], 10),
                        v = parseFloat(m["border" + u + "Width"], 10), b = g - t.offsets.popper[f] - _ - v;
                ...
                fn: function (t, e) {
                    ...
                    var n = He(t.instance.popper, t.instance.reference, e.padding, e.boundariesElement, t.positionFixed),
                        i = t.placement.split("-")[0], r = Me(i), o = t.placement.split("-")[1] || "", s = [];
                    switch (e.behavior) {
                        case rn.FLIP:
                            s = [i, r];
                            break;
                ...
                order: 800, enabled: !0, fn: function (t) {
                    ...
                    var e = t.offsets.reference, n = Ve(t.instance.modifiers, (function (t) {
                ...
                order: 850, enabled: !0, fn: function (t, e) {
                    var n = e.x, i = e.y, r = t.offsets.popper, o = Ve(t.instance.modifiers, (function (t) {
                        return "applyStyle" === t.name
                    })).gpuAcceleration;
                    void 0 !== o && console.warn("WARNING: `gpuAcceleration` option moved to `computeStyle` modifier and will not be supported in future versions of Popper.js!");
                    var s = void 0 !== o ? o : e.gpuAcceleration, a = be(t.instance.popper), l = Ne(a),
                        c = {position: r.position}, u = function (t, e) {
                            var n = t.offsets, i = n.popper, r = n.reference, o = Math.round, s = Math.floor,
                                a = function (t) {
                                    return t
                                }, l = o(r.width), c = o(i.width), u = -1 !== ["left", "right"].indexOf(t.placement),
                                f = -1 !== t.placement.indexOf("-"), h = e ? u || f || l % 2 == c % 2 ? o : s : a,
                                d = e ? o : a;
                            return {
                        ...
                        }(t, window.devicePixelRatio < 2 || !$e), f = "bottom" === n ? "top" : "bottom",
                        h = "right" === i ? "left" : "right", d = Xe("transform"), p = void 0, g = void 0;
                    if (g = "bottom" === f ? "HTML" === a.nodeName ? -a.clientHeight + u.bottom : -l.height + u.bottom : u.top, p = "right" === h ? "HTML" === a.nodeName ? -a.clientWidth + u.right : -l.width + u.right : u.left, s && d) c[d] = "translate3d(" + p + "px, " + g + "px, 0)", c[f] = 0, c[h] = 0, c.willChange = "transform"; else {
                        var m = "bottom" === f ? -1 : 1, _ = "right" === h ? -1 : 1;
                ...
                order: 900, enabled: !0, fn: function (t) {
                    ...
                    return e.setAttribute("x-placement", s), Ze(e, {position: n.positionFixed ? "fixed" : "absolute"}), n
        ...
        function t(e, n) {
            ...
            Ie(this, t), this.scheduleUpdate = function () {
                ...
                return Le({name: t}, i.options.modifiers[t])
            })).sort((function (t, e) {
    ...
    var ln = "dropdown", cn = "coreui.dropdown", un = "." + cn, fn = new RegExp("38|40|27"),
        hn = window.CoreUIDefaults && window.CoreUIDefaults.bsPrefix ? window.CoreUIDefaults.bsPrefix : "",
        dn = window.CoreUIDefaults && window.CoreUIDefaults.prefix ? window.CoreUIDefaults.prefix : "c-", pn = {
            HIDE: "hide" + un,
            HIDDEN: "hidden" + un,
            SHOW: "show" + un,
            SHOWN: "shown" + un,
        ...
        }, _n = "top-start", vn = "top-end", bn = "bottom-start", En = "bottom-end", yn = "right-start", An = "left-start",
        wn = {offset: 0, flip: !0, boundary: "scrollParent", reference: "toggle", display: "dynamic"}, Tn = {
            ...
            return n.toggle = function () {
                if (!this._element.disabled && !this._element.classList.contains(gn.DISABLED)) {
                    var e = t._getParentFromElement(this._element), n = this._menu.classList.contains(gn.SHOW);
                    if (t._clearMenus(), !n) {
                ...
                if (!(this._element.disabled || this._element.classList.contains(gn.DISABLED) || this._menu.classList.contains(gn.SHOW))) {
                    var e = t._getParentFromElement(this._element), n = {relatedTarget: this._element};
                ...
                var t = this._element.parentNode, e = bn;
                ...
                if (!e || 3 !== e.which && ("keyup" !== e.type || 9 === e.which)) for (var n = _(nt.find(mn.DATA_TOGGLE)), i = 0, r = n.length; i < r; i++) {
                    var o = t._getParentFromElement(n[i]), s = A.getData(n[i], cn), a = {relatedTarget: n[i]};
                    if (e && "click" === e.type && (a.clickEvent = e), s) {
                        var l = s._menu;
                        if (o.classList.contains(gn.SHOW)) if (!(e && ("click" === e.type && /input|textarea/i.test(e.target.tagName) || "keyup" === e.type && 9 === e.which) && o.contains(e.target))) K.trigger(o, pn.HIDE, a).defaultPrevented || ("ontouchstart" in document.documentElement && _(document.body.children).forEach((function (t) {
                ...
                if ((/input|textarea/i.test(e.target.tagName) ? !(32 === e.which || 27 !== e.which && (40 !== e.which && 38 !== e.which || nt.closest(e.target, mn.MENU))) : fn.test(e.which)) && (e.preventDefault(), e.stopPropagation(), !this.disabled && !this.classList.contains(gn.DISABLED))) {
                    var n = t._getParentFromElement(this), i = n.classList.contains(gn.SHOW);
    ...
    var Sn = "coreui.modal", On = "." + Sn,
        ...
        Nn = {backdrop: "(boolean|string)", keyboard: "boolean", focus: "boolean", show: "boolean"}, Pn = {
            HIDE: "hide" + On,
            HIDDEN: "hidden" + On,
            SHOW: "show" + On,
            SHOWN: "shown" + On,
            ...
            return n.toggle = function (t) {
                ...
                if (!this._isShown && !this._isTransitioning) {
                    ...
                    var n = K.trigger(this._element, Pn.SHOW, {relatedTarget: t});
                ...
                var e = this, n = this._element.classList.contains(Rn.FADE);
                ...
                var i = function () {
                    e._config.focus && e._element.focus(), e._isTransitioning = !1, K.trigger(e._element, Pn.SHOWN, {relatedTarget: t})
                };
                if (n) {
                ...
                var e = this, n = this._element.classList.contains(Rn.FADE) ? Rn.FADE : "";
    ...
    function jn(t, e, n) {
        ...
        for (var i = (new window.DOMParser).parseFromString(t, "text/html"), r = Object.keys(e), o = _(i.body.querySelectorAll("*")), s = function (t, n) {
            var i = o[t], s = i.nodeName.toLowerCase();
            if (-1 === r.indexOf(s)) return i.parentNode.removeChild(i), "continue";
            var a = _(i.attributes), l = [].concat(e["*"] || [], e[s] || []);
            a.forEach((function (t) {
    ...
    var Bn = "tooltip", Xn = ".coreui.tooltip",
        Gn = window.CoreUIDefaults && window.CoreUIDefaults.bsPrefix ? window.CoreUIDefaults.bsPrefix : "",
        Fn = Gn + "bs-tooltip", Kn = new RegExp("(^|\\s)" + Fn + "\\S+", "g"),
        Qn = ["sanitize", "whiteList", "sanitizeFn"], qn = {
            animation: "boolean",
            template: "string",
            ...
            whiteList: "object"
        }, zn = {AUTO: "auto", TOP: "top", RIGHT: "right", BOTTOM: "bottom", LEFT: "left"}, Zn = {
            animation: !0,
        ...
        }, ei = {FADE: Gn + "fade", SHOW: Gn + "show"},
        ni = {TOOLTIP_INNER: "." + Gn + "tooltip-inner", TOOLTIP_ARROW: "." + Gn + "tooltip-arrow"}, ii = "hover",
        ri = "focus", oi = "click", si = "manual", ai = function () {
            function t(t, e) {
            ...
            return n.enable = function () {
                ...
                if (this.isWithContent() && this._isEnabled) {
                    var e = K.trigger(this.element, this.constructor.Event.SHOW), n = function t(e) {
                    ...
                    var r = this.getTipElement(), o = u(this.constructor.NAME);
                    ...
                    A.setData(r, this.constructor.DATA_KEY, this), this.element.ownerDocument.documentElement.contains(this.tip) || c.appendChild(r), K.trigger(this.element, this.constructor.Event.INSERTED), this._popper = new an(this.element, r, {
                        ...
                        modifiers: {
                            ...
                            arrow: {element: ni.TOOLTIP_ARROW},
                ...
                var e = this, n = this.getTipElement(), i = function () {
                ...
                var t = this.getTipElement(), e = t.getAttribute("class").match(Kn);
                ...
                return this.each((function () {
                    var n = A.getData(this, "coreui.tooltip"), i = "object" == typeof e && e;
    ...
    var ci = "popover", ui = "coreui.popover", fi = "." + ui,
        hi = window.CoreUIDefaults && window.CoreUIDefaults.bsPrefix ? window.CoreUIDefaults.bsPrefix : "",
        di = hi + "bs-popover", pi = new RegExp("(^|\\s)" + di + "\\S+", "g"), gi = r({}, ai.Default, {
            placement: "right",
            trigger: "click",
            content: "",
        ...
        }), mi = r({}, ai.DefaultType, {content: "(string|element|function)"}), _i = {FADE: hi + "fade", SHOW: hi + "show"},
        vi = {TITLE: "." + hi + "popover-header", CONTENT: "." + hi + "popover-body"}, bi = {
            HIDE: "hide" + fi,
            HIDDEN: "hidden" + fi,
            SHOW: "show" + fi,
            SHOWN: "shown" + fi,
            ...
            return o.isWithContent = function () {
                ...
                var t = this.getTipElement(), e = t.getAttribute("class").match(pi);
                ...
                return this.each((function () {
                    var e = A.getData(this, ui), n = "object" == typeof t ? t : null;
    ...
    var Ai = "scrollspy", wi = "coreui.scrollspy", Ti = "." + wi,
        ...
        Oi = {ACTIVATE: "activate" + Ti, SCROLL: "scroll" + Ti, LOAD_DATA_API: "load" + Ti + ".data-api"},
        Li = {DROPDOWN_ITEM: Di + "dropdown-item", ACTIVE: Di + "active"}, Ci = {
        ...
        }, Ni = "offset", Pi = "position", Ri = function () {
            function t(t, e) {
                var n = this;
            ...
            return n.refresh = function () {
                var t = this, e = this._scrollElement === this._scrollElement.window ? Ni : Pi,
                    n = "auto" === this._config.method ? e : this._config.method, i = n === Pi ? this._getScrollTop() : 0;
                ...
                }))), K.trigger(this._scrollElement, Oi.ACTIVATE, {relatedTarget: t})
            }, n._clear = function () {
    ...
    function Xi(t, e) {
        var n = t.element.classList, i = ji.state.scrolling(e);
    ...
    Qi.prototype.eventElement = function (t) {
        ...
        var i = this.eventElement(t), r = function (t) {
            i.unbind(e, r), n(t)
        };
        i.bind(e, r)
    };
    ...
    var $i = {
        ...
        t.containerWidth = e.clientWidth, t.containerHeight = e.clientHeight, t.contentWidth = e.scrollWidth, t.contentHeight = e.scrollHeight, e.contains(t.scrollbarXRail) || (Yi(e, ji.element.rail("x")).forEach((function (t) {
            ...
            }), ki(e.scrollbarY, {top: e.scrollbarYTop, height: e.scrollbarYHeight - e.railBorderYWidth})
    ...
    function er(t, e) {
        var n = e[0], i = e[1], r = e[2], o = e[3], s = e[4], a = e[5], l = e[6], c = e[7], u = e[8], f = t.element,
    ...
    var nr = {
        "click-rail": function (t) {
            ...
            function n(n) {
                ...
                if (!function (t, n, i) {
                    ...
                    t.settings.useBothWheelAxes ? t.scrollbarYActive && !t.scrollbarXActive ? (o ? e.scrollTop -= o * t.settings.wheelSpeed : e.scrollTop += r * t.settings.wheelSpeed, s = !0) : t.scrollbarXActive && !t.scrollbarYActive && (r ? e.scrollLeft += r * t.settings.wheelSpeed : e.scrollLeft -= o * t.settings.wheelSpeed, s = !0) : (e.scrollTop -= o * t.settings.wheelSpeed, e.scrollLeft += r * t.settings.wheelSpeed), Ji(t), (s = s || function (n, i) {
                        var r = Math.floor(e.scrollTop), o = 0 === e.scrollTop,
                            s = r + e.offsetHeight === e.scrollHeight, a = 0 === e.scrollLeft,
            ...
            if ($i.supportsTouch || $i.supportsIePointer) {
                var e = t.element, n = {}, i = 0, r = {}, o = null;
            ...
            function u(o) {
                if (l(o)) {
                    var c = a(o), u = {pageX: c.pageX, pageY: c.pageY}, f = u.pageX - n.pageX, h = u.pageY - n.pageY;
                    if (function (t, n, i) {
                        if (!e.contains(t)) return !1;
                        for (var r = t; r && r !== e;) {
                            if (r.classList.contains(ji.element.consuming)) return !0;
                    ...
                    p > 0 && (r.x = f / p, r.y = h / p, i = d), function (n, i) {
                        var r = Math.floor(e.scrollTop), o = e.scrollLeft, s = Math.abs(n), a = Math.abs(i);
                        if (a > s) {
        ...
        this.scrollbarXBottom = parseInt(l.bottom, 10), isNaN(this.scrollbarXBottom) ? (this.isScrollbarXUsingBottom = !1, this.scrollbarXTop = Zi(l.top)) : this.isScrollbarXUsingBottom = !0, this.railBorderXWidth = Zi(l.borderLeftWidth) + Zi(l.borderRightWidth), ki(this.scrollbarXRail, {display: "block"}), this.railXMarginWidth = Zi(l.marginLeft) + Zi(l.marginRight), ki(this.scrollbarXRail, {display: ""}), this.railXWidth = null, this.railXRatio = null, this.scrollbarYRail = xi(ji.element.rail("y")), t.appendChild(this.scrollbarYRail), this.scrollbarY = xi(ji.element.thumb("y")), this.scrollbarYRail.appendChild(this.scrollbarY), this.scrollbarY.setAttribute("tabindex", 0), this.event.bind(this.scrollbarY, "focus", s), this.event.bind(this.scrollbarY, "blur", a), this.scrollbarYActive = null, this.scrollbarYHeight = null, this.scrollbarYTop = null;
        ...
        }(this.scrollbarY) : null, this.railBorderYWidth = Zi(c.borderTopWidth) + Zi(c.borderBottomWidth), ki(this.scrollbarYRail, {display: "block"}), this.railYMarginHeight = Zi(c.marginTop) + Zi(c.marginBottom), ki(this.scrollbarYRail, {display: ""}), this.railYHeight = null, this.railYRatio = null, this.reach = {
    ...
    var rr = function (t, e) {
            ...
            (void 0 === e && (e = document.body), function (t) {
                ...
                for (var t = {}, e = document.styleSheets, n = "", i = e.length - 1; i > -1; i--) {
                    for (var r = e[i].cssRules, o = r.length - 1; o > -1; o--) if (".ie-custom-properties" === r[o].selectorText) {
                        n = r[o].cssText;
                        break
                    }
                    if (n) break
        ...
        sr = {dropdownAccordion: "boolean"}, ar = 400, lr = {
            ACTIVE: or + "active",
            ...
            return n._getAllSiblings = function (t, e) {
                ...
                if (void 0 === t && (t = ur.NAVIGATION_CONTAINER), this._element.querySelector(t)) return new ir(this._element.querySelector(t), {suppressScrollX: !0})
                ...
                Array.from(this._element.querySelectorAll(ur.NAV_LINK)).forEach((function (e) {
                    var n, i = new RegExp("\\?.*="), r = new RegExp("\\?."), o = new RegExp("#.");
    ...
    var dr = "coreui.tab", pr = "." + dr,
        gr = window.CoreUIDefaults && window.CoreUIDefaults.bsPrefix ? window.CoreUIDefaults.bsPrefix : "", mr = {
            HIDE: "hide" + pr,
            HIDDEN: "hidden" + pr,
            SHOW: "show" + pr,
            SHOWN: "shown" + pr,
            ...
            return n.show = function () {
                ...
                if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && this._element.classList.contains(_r.ACTIVE) || this._element.classList.contains(_r.DISABLED))) {
                    var e, n, i = nt.closest(this._element, vr.NAV_LIST_GROUP), r = f(this._element);
                    if (i) {
                        var o = "UL" === i.nodeName || "OL" === i.nodeName ? vr.ACTIVE_UL : vr.ACTIVE;
                        n = (n = _(nt.find(o, i)))[n.length - 1]
                    }
                    var s = null;
                    if (n && (s = K.trigger(n, mr.HIDE, {relatedTarget: this._element})), !(K.trigger(this._element, mr.SHOW, {relatedTarget: n}).defaultPrevented || null !== s && s.defaultPrevented)) {
                        r && (e = nt.findOne(r)), this._activate(this._element, i);
                        var a = function () {
                            K.trigger(n, mr.HIDDEN, {relatedTarget: t._element}), K.trigger(t._element, mr.SHOWN, {relatedTarget: n})
                        };
                ...
                var i = this,
                    ...
                    o = n && r && r.classList.contains(_r.FADE), s = function () {
    ...
    var yr = "coreui.toast", Ar = "." + yr,
        wr = window.CoreUIDefaults && window.CoreUIDefaults.bsPrefix ? window.CoreUIDefaults.bsPrefix : "", Tr = {
            CLICK_DISMISS: "click.dismiss" + Ar,
            HIDE: "hide" + Ar,
            HIDDEN: "hidden" + Ar,
            SHOW: "show" + Ar,
            SHOWN: "shown" + Ar
        }, Dr = {FADE: wr + "fade", HIDE: wr + "hide", SHOW: wr + "show", SHOWING: wr + "showing"},
        Ir = {animation: "boolean", autohide: "boolean", delay: "number"},
        Sr = {animation: !0, autohide: !0, delay: 500}, Or = {DATA_DISMISS: '[data-dismiss="' + wr + 'toast"]'},
        Lr = function () {
            function t(t, e) {
    ...
    return window.getStyle = rr, window.hexToRgb = function (t) {
        ...
        var n = "0" + parseInt(e[1], 10).toString(16), i = "0" + parseInt(e[2], 10).toString(16),
